...
// TODO General comment: days are not multipliers now, but the basic construct for defining agenda's. Rework? How? If?

public class Friday extends DayOfWeek {

    public static final Day PROTODAY = new Day(30, 10, 2015);
    private static final int INDEX = PROTODAY.getDayOfWeek(); // This is a Friday.
    ...
    protected void makeActivities() {
        ...
        //work
        PossibleTimeIntervals time = new PossibleTimeIntervals(new Time(7, 0, 0), new Time(18, 0, 0), 180, 600);
        ...
        //dinner
        put(new PossibleHaveDinnerAtHome(), 0.9);

        //groceries
        time = new PossibleTimeIntervals(new Time(8, 0, 0), new Time(18, 0), 5, 2 * 60);
