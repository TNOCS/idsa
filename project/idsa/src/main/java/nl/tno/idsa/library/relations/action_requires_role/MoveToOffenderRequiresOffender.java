...
public class MoveToOffenderRequiresOffender extends RoleEnablesAction {
    public MoveToOffenderRequiresOffender() {
        super(Offender.class, MoveToOffender.class, false);
    }
}
